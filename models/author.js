...
AuthorSchema.virtual("lifespan").get(function () {
  ...
  if (this.date_of_death && this.date_of_birth) {
    ...
    return DateTime.fromJSDate(this.date_of_birth).toLocaleString(DateTime.DATE_MED) + ' - living' 
  } else if (this.date_of_death && !this.date_of_birth) {
    return 'unknown birthdate - ' + DateTime.fromJSDate(this.date_of_death).toLocaleString(DateTime.DATE_MED)
  } else {
    return 'unknown birth/death dates'
  }
  // return this.date_of_death ? DateTime.fromJSDate(this.date_of_death).toLocaleString(DateTime.DATE_MED) : ''; 
});
